...
/***/ (function(module, exports) {
	...
	function slider() {
		var sliderEl = document.querySelector('.slider__box');
		var switchEl = sliderEl.querySelector('.slider__switch');
		var widthSwitch = switchEl.offsetWidth;
		var widthSlider = sliderEl.offsetWidth;
		...
		function mouseDownListener(e) {
			...
			var switchElCoords = getCoords(switchEl);
			var shiftX = e.pageX - switchElCoords.left;
			var sliderElCoords = getCoords(sliderEl);
	
			function mouseMoveListener(ev) {
				ev.preventDefault();
	
				var newLeft = ev.pageX - shiftX - sliderElCoords.left;
	
				var leftEdge = -(widthSwitch / 2);
				var rightEdge = widthSlider - widthSwitch / 2;
		...
		switchEl.addEventListener('dragstart', function () {
			return false;
		});
	}
...
/***/ (function(module, exports) {
	...
	function about() {
		var inputBox = document.querySelector('.about__block');
		var lastInputEl = inputBox.lastElementChild;
		var inputElMaxLength = lastInputEl.getAttribute('maxlength');
	
		function addInput() {
			var inputElValueLength = lastInputEl.value.length;
			var newInput = lastInputEl.cloneNode();
			newInput.value = '';
